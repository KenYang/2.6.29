/*
 * Socle OTG USB device/endpoint management registers
 */
#ifndef __SOCLE_OTG_UDC_H
#define __SOCLE_OTG_UDC_H
...
struct socle_otg_udc {

	struct usb_gadget gadget;
	struct usb_gadget_driver *driver;
	struct socle_otg_ep *eps;
	unsigned int max_ep;
	unsigned int irq;
	...
	struct socle_otg_req *status_req;	/* ep0 status request */
...
#define WARN_SOCLE(stuff...)		printk(KERN_WARNING "udc: " stuff)		//20090527 leonid fix for warning message
